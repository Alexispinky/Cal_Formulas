    ...
    private fun evaluaPendiente() {
        when {
            ...
            binding.ans4.text.toString() == "" -> {
                ...
                parametros.putDouble(getString(R.string.x1),binding.ans1.text.toString().toDouble())
                parametros.putDouble(getString(R.string.y1),binding.ans2.text.toString().toDouble())
                parametros.putDouble(getString(R.string.x2),binding.ans3.text.toString().toDouble())
                parametros.putDouble(getString(R.string.y2),binding.ans4.text.toString().toDouble())
